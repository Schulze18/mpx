...
def quadruped_arm_wb_obj(swing_tracking,n_joints,n_contact,N,W,reference,x, u, t):
    ...
    friction_cone = penalty(friction_cone)
    torque_limits = jnp.array([
        50, 50, 50, 10, 10, 10, 5, 140, 130, 130, 140, 130, 130, 140, 130, 130, 140, 130, 130,
        50, 50, 50, 10, 10, 10, 5, 140, 130, 130, 140, 130, 130, 140, 130, 130, 140, 130, 130 ])
    #min grf 
    # min_force = grf[2::3] - jnp.ones(n_contact)*10
    torque_limits = jnp.kron(jnp.eye(n_joints),(jnp.array([-1,1]))).T@tau+torque_limits + jnp.ones_like(torque_limits)*1e-2
...
def quadruped_arm_wb_hessian_gn(swing_tracking,n_joints,n_contact,W,reference,x, u, t):
